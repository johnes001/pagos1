...
$ID_pago=$conex->buscar2("PAGOS", 'PRODUCTO', $_REQUEST['reference_sale']);


            if($conex->actualizar("PAGOS", 'ID', $ID_pago['ID'], $datos))
				{
				echo "Compra exitosa";
				mail('john@multilingua.edu.co', 'OK confirmacion.php PAYU', $mensaje);
				...
				mail('john@multilingua.edu.co', 'ERROR BASE DATOS confirmacion.php PAYU', $mensaje);
